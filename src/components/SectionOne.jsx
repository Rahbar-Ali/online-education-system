  ...
  return (
    <div className=" flex w-full  md:flex-row flex-col  h-screen max-h-[700px] ">
      <div className="xl:w-2/2 flex  items-center">
        <div className="w-full flex md:justify-end sm:justify-center mr-0 2xl:mr-12 md:mt-6 mt-14">
          <div
      ...
      <div className="w-full flex h-full flex-col md:justify-center ">
        <div className=" w-full flex flex-col items-center md:items-start">
          <h1 className="2xl:w-[70%] xl:text-6xl lg:text-5xl sm:mt-2 sm:text-4xl sm:mb-3  text-4xl font-bold mb-3 md:mb-8 text-center md:text-left mt-6 md:mt-0">
            Turn weaknesses into strengths
          </h1>
          <p className="xl:text-2xl text-sm sm:mb-4 px-2 sm:text-lg mb-4 md:mb-8 md:pr-10 text-center md:text-left mt-4 md:mt-0">
          ...
          <div className="w-55 h-17 bg-amber-500 ml-4 text-2xl text-center p-4 mt-4 md:mt-0">
            VIEW COURSES
          </div>
        </div>
      </div>
