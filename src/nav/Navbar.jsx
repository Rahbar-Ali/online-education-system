    ...
    <Disclosure as="nav">
      <div className="flex items-center w-full h-16 border-b-2 border-b-gray-100 py-9 sm:px-6 lg:px-8 ">
        <div className="relative flex  mx-2 w-full ">
          <div className="absolute inset-y-0 left-20 flex items-center w-1/2 justify-start  lg:hidden">
            {/* Mobile menu button*/}
          ...
          <div className="flex justify-end flex-0.5 lg:flex-1">
              ...
              {login.map((item) => (
                <a
                  ...
                  className={classNames(
                    ...
                    "rounded-md px-10 py-5  text-medium font-medium mx-1"
                  )}
                >
                  {item.name}
                </a>
